...
function atualizarCarrinho() {
  ...
  document.querySelector(".total").textContent = `Total: R$ ${total.toFixed(
    2
  )}`;
}
            ...
            <div class="pedido-card ${pedido.status.toLowerCase()}">
                ...
                <div class="status-buttons">
                    <button onclick="atualizarStatus(${
                      pedido.id
                    }, 'Em Preparo')">Em Preparo</button>
                    <button onclick="atualizarStatus(${
                      pedido.id
                    }, 'Saiu para Entrega')">Saiu para Entrega</button>
                    <button onclick="atualizarStatus(${
                      pedido.id
